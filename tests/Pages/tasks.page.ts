...
export class TasksPage {
   ...
   */
  async fillTaskInput(text: string) {
   ...
   */
  async expectTaskVisibleDesktop(id: string, text: string) {
   ...
   */
  async expectPriorityDesktop(id: string, priority: string) {
   ...
   */
  async expectFirstDesktopTaskText(text: string) {
   ...
   */
  async expectTaskVisibleMobile(id: string, text: string) {
   ...
   */
  async expectPriorityMobile(id: string, priority: string) {
   ...
   */
  async expectFirstMobileTaskText(text: string) {
   ...
   */
  async expectTaskNotVisible(id: string) {
   ...
   */
  async expectTaskInCompleted(id: string, text: string) {
   ...
   */
  async startEditDesktop(id: string) {
   ...
   */
  async editTaskDesktop(id: string, newText: string) {
   ...
   */
  async cancelEditDesktop(id: string, tempText: string) {
   ...
   * @param {number} id - Task id to be edited.
   */
  async startEditMobile(id: string) {
   ...
   * @param {string} newText - New description to replace the old one.
   */
  async editTaskMobile(id: string, newText: string) {
   ...
   * @param {string} tempText - Temporary text used before canceling.
   */
  async cancelEditMobile(id: string, tempText: string) {
   ...
   */
  async completeTaskDesktop(id: string) {
   ...
   * @param {number} id - Task id to complete.
   */
  async completeTaskMobile(id: string) {
   ...
   */
  async dragTaskDesktop(sourceId: string, targetId: string) {
